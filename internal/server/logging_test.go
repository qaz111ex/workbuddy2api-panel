...
func TestLogChatRowFormat(t *testing.T) {
	...
	out := captureStdout(t, func() {
		logChatRow(412*time.Millisecond, 27100*time.Millisecond, "deepseek-v4-flash", "stream", "00e26541abcdef", "猫猫", http.StatusOK, 1234)
	})
	for _, want := range []string{
		"| #", "deepseek-v4", "| stream |", "| 200 |", "猫猫(00e26541)", "TTFB=412ms", "tok=1234", "tok/s |", "total=",
	} {
